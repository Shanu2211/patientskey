...
<%
	...
	String query = "select * from pathoregtbl where email=? and password=?";
	...
	ResultSet rs = ps.executeQuery();
		...
		if(rs.next())
		{
			...
			<div class="topnav" style="background: lightgrey">
				  ...
				  <h3 align="right" style="background-color: orange"><a href="#">Welcome <%out.println(rs.getString("name"));%></a></h3>
			</div>
			...
			<form action="pathologaction1.jsp" >
		   <input type="text" value="<%out.println(rs.getString("name"));%>" name="name" style="color:black" hidden>
			<h2><b>Choose Filter Option:</b></h2>
				
   				<input type="submit" class="btn btn-success" style="background-color:orange;color:white;margin-left:43%;margin-top:5%;font-size:23px" value="Watch Your Customers"/>
